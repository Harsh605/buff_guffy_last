    ...
    <section className="page-frontpage container content-box mt-5 pl-2 pr-2">
      ...
      <div className="box box-small ">
        <div className="box-inner">
          <h1 style={{ textAlign: 'center', color: "#ffffff",fontSize:"34px" }}>Revolutionizing Education Finance - DeFi, <br />Arbitrum,  and Empowering Students and Institutions Globally</h1>
        </div>
      </div>
